...
export default function ProductCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAntibiotic(initialValues.antibiotic);
    setAvailableForPickup(initialValues.availableForPickup);
    setBrandName(initialValues.brandName);
    setCode(initialValues.code);
    setConfigurable(initialValues.configurable);
    setDescription(initialValues.description);
    setEans(initialValues.eans);
    setCurrentEansValue("");
    setExclusionCode(initialValues.exclusionCode);
    setHasDiscountPrice(initialValues.hasDiscountPrice);
    setIsLabProduct(initialValues.isLabProduct);
    setName(initialValues.name);
    setNaturalHealth(initialValues.naturalHealth);
    setNumberOfReviews(initialValues.numberOfReviews);
    setPotentialPromotions(initialValues.potentialPromotions);
    setCurrentPotentialPromotionsValue("");
    setPresentation(initialValues.presentation);
    setProductReferences(initialValues.productReferences);
    setCurrentProductReferencesValue("");
    setProviderName(initialValues.providerName);
    setPurchasable(initialValues.purchasable);
